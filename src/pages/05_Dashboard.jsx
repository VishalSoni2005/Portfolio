            ...
            <div className="max-w-6xl mx-auto">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <div className="mb-4 md:mb-0">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-bold text-lg">Vishal Soni</span>
                  </div>
              ...
              <div className="border-t border-gray-800 mt-6 pt-6 flex flex-col md:flex-row justify-between items-center">
                <p className="text-gray-400 text-sm">
                  © {new Date().getFullYear()} Vishal Soni. All rights
                  reserved.
                </p>
...
//         { name: 'TypeScript', level: 85, icon: null },
//         { name: 'HTML5', level: 95, icon: <FaHtml5 /> },
//         { name: 'CSS3/SASS', level: 90, icon: <FaCss3 /> },
//         { name: 'Redux', level: 85, icon: null },
//         { name: 'Next.js', level: 80, icon: null },
...
//         { name: 'Express', level: 85, icon: null },
//         { name: 'RESTful APIs', level: 90, icon: null },
//         { name: 'GraphQL', level: 80, icon: null },
//         { name: 'WebSockets', level: 85, icon: null },
//       ],
//     },
//     {
//       name: 'Database',
...
//         { name: 'PostgreSQL', level: 80, icon: null },
//         { name: 'Redis', level: 75, icon: null },
//         { name: 'Firebase', level: 80, icon: null },
//       ],
//     },
//     {
//       name: 'DevOps & Tools',
...
//         { name: 'CI/CD', level: 75, icon: null },
//         { name: 'AWS', level: 70, icon: null },
//         { name: 'Testing (Jest, Cypress)', level: 80, icon: null },
//       ],
//     },
//     {
//       name: 'Specialized',
//       skills: [
//         { name: 'WebRTC', level: 85, icon: null },
//         { name: 'Socket.io', level: 90, icon: null },
//         { name: 'Encryption', level: 80, icon: <FaLock /> },
//         { name: 'AI Integration', level: 75, icon: <FaRobot /> },
//         { name: 'Responsive Design', level: 95, icon: null },
//       ],
//     },
//   ];
...
//       title: 'Remote Interview Platform',
//       description:
//         'Developed a comprehensive platform for technical interviews',
//     },
//     {
//       year: '2022',
//       title: 'End-to-End Encrypted Chat App',
//       description: 'Built a secure messaging platform with advanced encryption',
//     },
//     {
//       year: '2021',
//       title: 'AI-Powered Blog Platform',
//       description:
//         'Created an intelligent content platform with AI capabilities',
//     },
//     {
//       year: '2020',
//       title: 'Senior Developer',
//       description: 'Promoted to senior developer role at Tech Solutions Inc.',
//     },
//     {
//       year: '2018',
//       title: 'Frontend Developer',
//       description: 'Started career as a frontend developer at WebCraft',
//     },
//   ];
...
//         className={`${
//           isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
//         } transform fixed md:relative z-10 w-64 bg-gray-900 text-white transition-transform duration-300 ease-in-out h-full flex flex-col`}
//       >
//         <div className="p-4 border-b border-gray-800 flex items-center space-x-3">
...
//           </div>
//           <div>
//             <h2 className="font-bold text-lg">John Developer</h2>
//             <p className="text-xs text-gray-400">Full Stack Developer</p>
//           </div>
//         </div>
...
//                   modern web applications with React, Node.js, and cutting-edge
//                   technologies. Explore my projects and skills below.
//                 </p>
...
//                       <div
//                         key={index}
//                         className={`px-3 py-2 rounded-full text-white font-medium text-sm
//                           ${
//                             skill.level > 90
//                               ? 'bg-blue-500'
//                               : skill.level > 80
...
//                       </div>
//                     ))}
//                   <div className="px-3 py-2 rounded-full bg-gray-200 text-gray-700 font-medium text-sm">
...
//           {/* Skills Tab */}
//           {activeTab === 'skills' && (
//             <div className="space-y-6" id="skills-section">
...
//                   Skill Distribution
//                 </h2>
//                 <div className="aspect-square max-w-md mx-auto bg-gray-100 rounded-full flex items-center justify-center">
//                   <p className="text-gray-500">Radar Chart Placeholder</p>
//                   {/* In a real implementation, you would use a library like Chart.js or Recharts to create a radar chart */}
//                 </div>
//               </div>
//             </div>
//           )}
...
//           {activeTab === 'timeline' && (
//             <div className="space-y-6">
//               <h1 className="text-3xl font-bold text-gray-800">My Journey</h1>
//               <p className="text-gray-600 max-w-3xl">
//                 Here's a timeline of my professional journey and key projects.
//               </p>
...
//                         {/* Circle */}
//                         <div className="absolute left-0 top-1.5 w-10 h-10 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold text-sm">
//                           {item.year}
//                         </div>
...
//                       <FaEnvelope className="h-5 w-5 text-blue-500 mt-0.5" />
//                       <div>
...
//                         <p className="text-gray-600">www.johndeveloper.com</p>
//                       </div>
//                     </div>
//                     <div className="flex items-start space-x-3">
//                       <FaGithub className="h-5 w-5 text-blue-500 mt-0.5" />
//                       <div>
...
//                     </div>
//                     <div className="flex items-start space-x-3">
//                       <FaLinkedin className="h-5 w-5 text-blue-500 mt-0.5" />
//                       <div>
...
//                       <a
//                         href="#"
//                         className="h-10 w-10 rounded-full bg-blue-100 text-blue-500 flex items-center justify-center hover:bg-blue-500 hover:text-white transition-colors"
//                       >
//                         <FaGithub className="h-5 w-5" />
//                       </a>
//                       <a
