        ...
        <div className="container max-w-5xl px-6 py-16 mx-auto">
          <div className="grid gap-6 mx-4 sm:grid-cols-12">
            <div className="col-span-12 sm:col-span-3">
              <div className="hidden sm:block text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:dark:bg-green-500">
